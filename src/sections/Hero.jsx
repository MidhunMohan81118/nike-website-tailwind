  ...
  return (
    <section id="home" className="w-full flex xl:flex-row flex-col justify-center
     min-h-screen gap-10 max-container">
      ...
      items-start w-full max-xl:padding-xl pt-28">
        ...
        max-sm:text-[72px] max-sm:leading-[82px] font-bold">
          ...
          relative z-10 pr-10">The New Arrivals</span><br />
...
{/* 
justify-starts-->to start from fa-pull-left
items-start-->to start from top 
*/}
